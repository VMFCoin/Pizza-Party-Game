...
import "./PizzaPartyV2.sol";

/**
 * @title PizzaParlorManager
 * @dev Manages Pizza Parlor franchises for the Pizza Party ecosystem
 *
 * Features:
 ...
 * - Owner fees from daily pot: Accumulated for future distribution
 */
contract PizzaParlorManager is Ownable, ReentrancyGuard {
    ...
    IERC20 public immutable pizzaToken;
    PizzaPartyV2 public immutable pizzaParty;
    address public immutable treasury;
    address public immutable ops;

    // Parlor price: $50 at $0.001/PIZZA = 50,000 PIZZA
    uint256 public parlorPricePizza = 50000e18;

    // Free entries per parlor per day
    uint256 public dailyFreeEntriesPerParlor = 1;
    ...
    constructor(
        ...
        pizzaParty = PizzaPartyV2(_pizzaParty);
        treasury = _treasury;
        ops = _ops;
    }
