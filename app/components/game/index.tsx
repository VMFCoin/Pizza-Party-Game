    ...
    >
      <div className="w-full max-w-sm flex flex-col items-center gap-4">
        ...
        <div className="bg-blue-100/90 backdrop-blur-sm p-3 rounded-xl border-4 border-black w-full text-center">
          <p className="text-blue-600 font-bold" style={{ fontFamily: 'var(--font-luckiest-guy)', fontSize: '24px' }}>Daily Jackpot</p>
      ...
      <p className="text-xs text-red-500 text-center mt-1">
        ...
        <div className="bg-blue-50 p-4 rounded-xl border-4 border-black w-full text-center">
          <div className="flex items-center justify-center mb-2">
            ...
            <p className="font-semibold text-blue-800" style={{ fontFamily: 'var(--font-luckiest-guy)', fontSize: '19px' }}>Next Draw In:</p>
          </div>
